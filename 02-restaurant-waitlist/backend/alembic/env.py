...
# Same DATABASE_URL the app reads (see `backend/config.py`), falling back to
# whatever is in alembic.ini (e.g. for `alembic revision --autogenerate` run
# without an env var set).
